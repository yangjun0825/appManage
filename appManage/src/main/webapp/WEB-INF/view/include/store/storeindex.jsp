...
<html>
	...
	<body>
		...
		<div class="section">
			<div class="section_header">药店列表</div>
			...
			<div id="list_div">
				...
				<div class="clear"></div>
				<button class="show_more" id="store_more">点击查看更多</button>
		...
		<div class="section">
			...
			<div class="search_drugstore">
				<input type="text" class="search_field" id="storeName" placeholder="请输入药店名称" />
				<button class="search_button">搜索</button>
			</div>
		</div>
		
		<div class="section">
			<div class="section_header">推荐药店</div>
			<div>
				<ul class="drug_stores">
					<c:if test="${recomdrugStoreList!=null}">
						 <c:forEach items="${recomdrugStoreList}" var="store">
							<li>
								<input id="storeId" type="hidden" value="${store.id}"/>
								<div>${store.storename}</div>
							</li>
